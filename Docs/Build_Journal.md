...
![School Backyard Recycled Wood Spot](Build-photos/school_backyard_wood.png)

So, I took this old desk and took the top layer from it so I can use it as the base.

![Old Desk Top Layer Base](Build-photos/desk_top_base.png)
...
![PVC Pipes Found At Home](Build-photos/pvc_pipes_home.png)
![Thin Wood Supporters](Build-photos/thin_wood_supporters.png)
...
![Dismantling Old Drawers For Parts](Build-photos/dismantling_drawers.png)
![Drawer Wood Cut Into Columns](Build-photos/drawer_columns_broken.png)
...
![Reinforced Outer Structure Frame](Build-photos/outer_frame_assembled.png)
...
* **Image Reference:** ![Soil Drawer with Plastic Lining](Build-photos/soil_drawer_plastic_lining.png)
...
![Lifting Blocks Under Soil Drawer](Build-photos/drawer_elevation_blocks.png)
...
![Peltier Cooling Module Setup and Fans](Build-photos/peltier_cooling_system_assembly.png)
...
![Shaped Wooden Smooth Arch](Build-photos/wooden_smooth_arc.png)
...
![Nail Mod Installation Hack for Columns](Build-photos/column_nail_head_mod.png)
...
![Servo Coupling Inside PVC Pipe](Build-photos/servo_pvc_coupling.png)
...
![Dual Breadboard Circuit Layout](Build-photos/dual_breadboard_circuit.png)
...
![PC Power Supply Unit Interfacing](Build-photos/psu_voltage_rails.png)
...
![Angled Wooden Control Panel Frame](Build-photos/wooden_control_panel.png)
...
![TFT Display Running Inside Panel](Build-photos/control_panel_screen_active.png)
...
* **Image Reference:** ![Sensor and Actuator Wiring Paths](Build-photos/wiring_harness_routing.png)
...
![Soldered NeoPixel Chain Fixed with Hot Glue](Build-photos/neopixel_chain_soldering.png)
...
![Hot Gluing the Transparent Enclosure Sheets](Build-photos/gluing_greenhouse_sheets.png)
...
![Hand-Crafted Ventilation Hinged Windows](Build-photos/top_ventilation_windows.png)
...
* **Image Reference:** ![Completed Functional Prototype Front View](Build-photos/final_greenhouse_prototype.png)